        ...
        >
          ...
          {step === 3 && (
            <Card className="p-8 lg:p-12 space-y-12 overflow-hidden relative">
              ...
              <div className="flex flex-col sm:flex-row justify-between gap-4 pt-12 border-t border-slate-50 relative z-10">
                <div className="flex gap-4 order-2 sm:order-1">
                  <Button 
                    variant="ghost" 
                    onClick={prevStep} 
                    disabled={loading}
                    className="h-14 px-8 rounded-2xl border-2 font-black text-[10px] uppercase tracking-widest"
                  >
                    Quay lại
                  </Button>
                  <Button 
                ...
                <div className="flex gap-4 order-1 sm:order-2">
                  ...
                  <Button 
                    ...
                    disabled={loading}
                    className="h-16 px-10 rounded-[2rem] bg-slate-900 shadow-2xl shadow-slate-400 font-black text-[11px] uppercase tracking-[0.2em] flex items-center gap-3 hover:bg-black transition-all hover:scale-[1.02] active:scale-95"
                  >
                    {loading ? (

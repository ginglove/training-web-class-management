    ...
    <div className="max-w-6xl mx-auto space-y-12 pb-24">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div className="space-y-1">
              ...
              <h1 className="text-4xl font-black tracking-tight text-slate-800">Pending Queue Queue</h1>
            </div>
          </div>
          <p className="text-slate-500 font-medium max-w-xl">Review and process new booking requests from creators to ensure training goals.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="p-6 border-l-4 border-l-amber-500 flex items-center gap-5">
          ...
          <div>
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">High Priority</p>
        ...
        <Card className="p-6 border-l-4 border-l-emerald-500 flex items-center gap-5">
          ...
          <div>
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Total Attendees</p>
            <p className="text-2xl font-black text-slate-800">
      ...
      <div className="grid grid-cols-1 gap-8">
        {loading ? (
                ...
                <div className="flex-1 p-8 lg:p-12 space-y-8">
                  <div className="flex justify-between items-start">
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        <Badge className="bg-amber-50 text-amber-500 border border-amber-100 px-4 py-1.5 text-[9px] font-black tracking-[0.15em] uppercase rounded-xl">NEW</Badge>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    <div className="flex items-center gap-5 text-slate-600">
                      ...
                      <div className="space-y-0.5">
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.15em]">Room</p>
                    ...
                    <div className="flex items-center gap-5 text-slate-600">
                      ...
                      <div className="space-y-0.5">
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.15em]">Attendees</p>
                        <p className="font-black text-slate-700">{b.attendee_count} people</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-5 text-slate-600">
                      <div className="w-12 h-12 rounded-[1.2rem] bg-slate-50 flex items-center justify-center border border-slate-100 group-hover:bg-primary/5 group-hover:border-primary/20 transition-all">
                      ...
                      <div className="space-y-0.5">
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.15em]">Creator</p>
          ...
          <div className="py-32 text-center space-y-8 bg-white rounded-[3rem] border border-slate-100 shadow-xl shadow-slate-200/20">
            ...
            <div className="space-y-3">
              <h3 className="text-3xl font-black text-slate-800">Queue is empty 🧊</h3>
              <p className="text-slate-500 font-medium max-w-sm mx-auto leading-relaxed">All requests have been processed or no new requests yet.</p>
            </div>
            <button 

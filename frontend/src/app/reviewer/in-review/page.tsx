        ...
        {loading ? (
                  ...
                  <div className="flex justify-between items-start">
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-[10px] font-black text-slate-300 uppercase tracking-[0.2em]">Bắt đầu: {format(new Date(b.updated_at), 'HH:mm • dd/MM')}</span>
                      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div className="flex items-center gap-5 text-slate-600">
                      ...
                      <div className="space-y-0.5">
                        ...
                        <p className="font-black text-slate-700">{format(new Date(b.date), 'dd/MM/yyyy')}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-5 text-slate-600">
                      <div className="w-12 h-12 rounded-[1.2rem] bg-slate-50 flex items-center justify-center border border-slate-100 group-hover:bg-primary/5 group-hover:border-primary/20 transition-all">
          ...
          <div className="py-32 text-center space-y-8 bg-white rounded-[3rem] border border-slate-100 shadow-xl shadow-slate-200/20">
            ...
            <div className="space-y-3">
              ...
              <p className="text-slate-500 font-medium max-w-sm mx-auto leading-relaxed">Bạn chưa tiếp nhận hồ sơ nào hoặc đã hoàn tất toàn bộ danh sách cá nhân.</p>
            </div>
